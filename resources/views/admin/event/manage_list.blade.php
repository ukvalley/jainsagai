                    ...
                    <tbody>
                        @foreach($data as $key=>$user)
                          <tr>
                              ...
                              <td>
                                <a href="{{url('/')}}/edit_event/{{$user['id']}}"><i class="fa fa-edit"></i></a>
                                <a href="{{url('/')}}/viewevent/{{$user['id']}}"><i class="fa fa-eye"></i></a>
                                <a href="{{url('/')}}/deleteevent/{{$user['id']}}"><i class="fa fa-trash"></i></a>
                              </td>
                          </tr>
                        @endforeach
                    </tbody>
